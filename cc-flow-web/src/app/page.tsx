      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Create complex CC-Flow workflows with an intuitive drag-and-drop
            interface. Build, visualize, and export your agent workflows
            effortlessly.
          </p>
              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Drag and drop agents to create complex workflows with visual
                    connections.
                  </p>
                </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-lg text-gray-500">
                  Launch the web editor from your CC-Flow CLI and start building
                  workflows visually.
                </p>
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  <div className="text-green-400 font-mono text-sm">
                    ...
                    <div className="text-gray-400 mb-2">
                      🌐 Opening workflow editor at http://localhost:3000
                    </div>
                    <div className="text-gray-400 mb-2">
