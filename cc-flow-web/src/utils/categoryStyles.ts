...
export const COLOR_PALETTE = [
  ...
  },
  {
    ...
    handleBorder: "border-emerald-400",
  ...
  },
  {
    ...
    handleBorder: "border-violet-400",
  ...
  },
  {
    ...
    handleBorder: "border-indigo-400",
...
export function getCategoryColors(category?: string) {
  if (!category) {
    return {
      ...
      handleBorder: "border-indigo-300",
