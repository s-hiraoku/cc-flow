...
Intelligently create or update steering documents in `.kiro/steering/` to maintain accurate project knowledge for spec-driven development. This agent detects existing documents and handles them appropriately.
...
- Custom steering files: Any additional .md files in .kiro/steering/

## Project Analysis

### Current Project State
Analyze project files:
- Source files: Look for .py, .js, .ts, .jsx, .tsx, .java, .go, .rs files
- Configuration files: package.json, requirements.txt, pom.xml, Cargo.toml, go.mod, pyproject.toml, tsconfig.json
- Documentation: README files, CHANGELOG, LICENSE, .md files
...
Based on the existing files check, this agent will:
