...
Generate comprehensive requirements for a specification using EARS format.
...
- Current spec directory: .kiro/specs/{feature-name}/
...
Use spec-design agent to proceed to design phase
